...
func drop_data(_position, data):
	...
	var my_item=weapon_inventury.items[my_item_index]
	weapon_inventury.swap_items(my_item_index,data.item_index)
	weapon_inventury.set_item(my_item_index,data.item)
	weapon_inventury.drag_data=null
